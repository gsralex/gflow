 ...
 * @date 2020/2/2
 */
public class MessageEncoder extends MessageToByteEncoder<GFlowRequest> {

    @Override
    protected void encode(ChannelHandlerContext channelHandlerContext, GFlowRequest message, ByteBuf buf) throws Exception {
